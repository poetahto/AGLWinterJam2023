...
namespace poetools
{
    ...
    public static class RichTextFormatExtensions
    {
        ...
        public static IRichTextData Rtf(this Color color)
        {
            ...
            return global::poetools.Rtf.Color(hexColor);
        }
        ...
        {
            return message.Format(global::poetools.Rtf.Bold);
        }
        
        public static string Italic(this string message)
        {
            return message.Format(global::poetools.Rtf.Italic);
        }
        ...
        {
            return message.Format(global::poetools.Rtf.Size(size));
        }
        
        public static string Material(this string message, ushort id)
        {
            return message.Format(global::poetools.Rtf.Material(id));
        }

        #region Colors

        public static string Aqua(this string message)      { return message.Format(global::poetools.Rtf.AquaColor); }
        public static string Black(this string message)     { return message.Format(global::poetools.Rtf.BlackColor); }
        public static string Blue(this string message)      { return message.Format(global::poetools.Rtf.BlueColor); }
        public static string Brown(this string message)     { return message.Format(global::poetools.Rtf.BrownColor); }
        public static string Cyan(this string message)      { return message.Format(global::poetools.Rtf.CyanColor); }
        public static string DarkBlue(this string message)  { return message.Format(global::poetools.Rtf.DarkBlueColor); }
        public static string Fuchsia(this string message)   { return message.Format(global::poetools.Rtf.FuchsiaColor); }
        public static string Green(this string message)     { return message.Format(global::poetools.Rtf.GreenColor); }
        public static string Grey(this string message)      { return message.Format(global::poetools.Rtf.GreyColor); }
        public static string LightBlue(this string message) { return message.Format(global::poetools.Rtf.LightBlueColor); }
        public static string Lime(this string message)      { return message.Format(global::poetools.Rtf.LimeColor); }
        public static string Magenta(this string message)   { return message.Format(global::poetools.Rtf.MagentaColor); }
        public static string Maroon(this string message)    { return message.Format(global::poetools.Rtf.MaroonColor); }
        public static string Navy(this string message)      { return message.Format(global::poetools.Rtf.NavyColor); }
        public static string Olive(this string message)     { return message.Format(global::poetools.Rtf.OliveColor); }
        public static string Orange(this string message)    { return message.Format(global::poetools.Rtf.OrangeColor); }
        public static string Purple(this string message)    { return message.Format(global::poetools.Rtf.PurpleColor); }
        public static string Red(this string message)       { return message.Format(global::poetools.Rtf.RedColor); }
        public static string Silver(this string message)    { return message.Format(global::poetools.Rtf.SilverColor); }
        public static string Teal(this string message)      { return message.Format(global::poetools.Rtf.TealColor); }
        public static string White(this string message)     { return message.Format(global::poetools.Rtf.WhiteColor); }
        public static string Yellow(this string message)    { return message.Format(global::poetools.Rtf.YellowColor); }
